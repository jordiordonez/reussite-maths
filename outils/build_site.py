...
<div class="site-tile" style="max-width:66ch">
  ...
  <p class="site-hint">Le paiement se fait sur PayPal, hors de ce site. Aucune donnée n’est collectée ici.</p>
</div>
...
<div class="site-tile" style="max-width:66ch">
  <ul>
    ...
    <li>Il n’y a ni publicité, ni traçage, ni compte. Votre suivi reste dans votre navigateur.</li>
