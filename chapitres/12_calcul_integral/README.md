...
Rapports : [12A](../../revue/12A.md) et [12B](../../revue/12B.md).

```bash
python3 outils/chapitre12/test_math.py
python3 outils/check_fiche.py chapitres/12_calcul_integral/12A_integrales_aires.html chapitres/12_calcul_integral/12B_integration_methodes.html
