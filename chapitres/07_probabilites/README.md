...
Le protocole est [revue/PROTOCOLE.md](../../revue/PROTOCOLE.md). Rapports propres à ce chapitre : [7A](../../revue/7A.md), [7B](../../revue/7B.md), [7C](../../revue/7C.md).
...
python3 outils/build_site.py --only \
  chapitres/07_probabilites/7A_probabilites_conditionnelles.html \
  chapitres/07_probabilites/7B_variables_aleatoires.html \
  chapitres/07_probabilites/7C_epreuves_independantes_bernoulli.html \
