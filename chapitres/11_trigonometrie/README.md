...
Rapports : [10A](../../revue/11A.md) et [10B](../../revue/11B.md).

```bash
python3 outils/chapitre10/test_math.py
python3 outils/check_fiche.py chapitres/11_trigonometrie/11A_cercle_trigonometrique.html
python3 outils/check_fiche.py chapitres/11_trigonometrie/11B_derivation_trigonometrie.html
...
python3 outils/build_site.py --only \
  chapitres/11_trigonometrie/11A_cercle_trigonometrique.html \
  chapitres/11_trigonometrie/11B_derivation_trigonometrie.html \
...
La fiche 11A a d'abord été écrite comme socle de la dérivation des fonctions trigonométriques en Terminale. Pour un élève de **Première**, trois éléments du programme n'y figurent pas encore :
